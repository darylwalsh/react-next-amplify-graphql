;(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \********************************************************************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! core-js/library/fn/object/get-own-property-descriptors */ './node_modules/core-js/library/fn/object/get-own-property-descriptors.js',
        )
  ...
  \********************************************************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        __webpack_require__(
          /*! ../../modules/es7.object.get-own-property-descriptors */ './node_modules/core-js/library/modules/es7.object.get-own-property-descriptors.js',
        )
        module.exports = __webpack_require__(
          /*! ../../modules/_core */ './node_modules/core-js/library/modules/_core.js',
  ...
  \*****************************************************************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var ownKeys = __webpack_require__(
          /*! ./_own-keys */ './node_modules/core-js/library/modules/_own-keys.js',
        )
        var toIObject = __webpack_require__(
          /*! ./_to-iobject */ './node_modules/core-js/library/modules/_to-iobject.js',
        )
        ...
        /* WEBPACK VAR INJECTION */ ;(function(process) {
          ...
          var mapTraps = finalizeTraps({
            ...
            clear: function(state) {
              return function() {
                ...
                for (
                  var i = 0, list = latest$1(state).keys();
                  i < list.length;
                  i += 1
                ) {
                  var key = list[i]
          ...
          function hasObjectChanges(state) {
            ...
            for (var i = keys.length - 1; i >= 0; i--) {
              ...
              // descriptor is erased. This branch detects any missed changes.
                ...
                if (
                  state$1 ? state$1.base !== baseValue : !is(value, baseValue)
                ) {
                  return true
                }
              }
          ...
          var objectTraps = {
            ...
            deleteProperty: function deleteProperty(state, prop) {
              // The `undefined` check is a fast path for pre-existing keys.
              if (
                peek$1(state.base, prop) !== undefined ||
                prop in state.base
              ) {
          ...
          var reflectTraps = makeReflectTraps([
            'ownKeys',
            'has',
            'set',
            'deleteProperty',
          ...
          var mapTraps$1 = makeTrapsForGetters(
            ((obj$1 = {}),
            (obj$1[DRAFT_STATE] = function(state) {
              return state
            }),
            ...
            (obj$1.clear = function(state) {
              return function() {
                ...
                for (
                  var i = 0, list = latest$2(state).keys();
                  i < list.length;
                  i += 1
                ) {
                  var key = list[i]
            ...
            (obj$1.values = iterateMapValues),
            (obj$1.entries = iterateMapValues),
            (obj$1[
          ...
          var setTraps$1 = makeTrapsForGetters(
            ((obj$1$1 = {}),
            (obj$1$1[DRAFT_STATE] = function(state) {
              return state
            }),
            ...
            (obj$1$1.keys = iterateSetValues$1),
            (obj$1$1.values = iterateSetValues$1),
            (obj$1$1.entries = iterateSetValues$1),
            (obj$1$1[
              hasSymbol ? Symbol.iterator : '@@iterator'
            ] = iterateSetValues$1),
            obj$1$1),
          ...
          function makeReflectTraps(names) {
            return names.reduce(function(traps, name) {
              traps[name] = function(state) {
                ...
                return Reflect[name].apply(
                  Reflect,
                  [latest$2(state)].concat(args),
                )
              }
          ...
          function generatePatches(state, basePath, patches, inversePatches) {
            var generatePatchesFn = Array.isArray(state.base)
  ...
  \**********************************************/
    ...
    /***/ './node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=%2Fhome%2Fbarko187%2FWorkspace%2FReact%2Freact-next-amplify-graphql%2Fpages%2Findex.tsx!./':
      /*!****************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=%2Fhome%2Fbarko187%2FWorkspace%2FReact%2Freact-next-amplify-graphql%2Fpages%2Findex.tsx ***!
  \****************************************************************************************************************************************************************************************************/
      /*! no static exports found */
  ...
  \*******************************************************************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! dll-reference dll_5f137288facb1107b491 */ 'dll-reference dll_5f137288facb1107b491',
        )('./node_modules/react/index.js')
  ...
  \*************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! nanoid */ './node_modules/nanoid/index.browser.js',
        )
        /* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/ __webpack_require__.n(
          nanoid__WEBPACK_IMPORTED_MODULE_11__,
        )
        /* harmony import */ var immer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
        ...
        var reducer = function reducer(state, action) {
          switch (action.type) {
            case 'set-current': {
              return Object(immer__WEBPACK_IMPORTED_MODULE_12__['default'])(
                state,
                function(draft) {
    ...
    /***/ 0:
      /*!********************************************************************************************************************************************************!*\
  !*** multi next-client-pages-loader?page=%2F&absolutePagePath=%2Fhome%2Fbarko187%2FWorkspace%2FReact%2Freact-next-amplify-graphql%2Fpages%2Findex.tsx ***!
  \********************************************************************************************************************************************************/
      /*! no static exports found */
      /***/ function(module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! next-client-pages-loader?page=%2F&absolutePagePath=%2Fhome%2Fbarko187%2FWorkspace%2FReact%2Freact-next-amplify-graphql%2Fpages%2Findex.tsx! */ './node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=%2Fhome%2Fbarko187%2FWorkspace%2FReact%2Freact-next-amplify-graphql%2Fpages%2Findex.tsx!./',
        )
